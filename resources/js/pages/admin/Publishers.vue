<template>
    <div class="container-fluid">
        <div v-for="p in publishers" :key="p.id">
            <div>
                <p> {{p.name}} </p>
            </div>
            <hr>
            <div class="col mt-5">
                <div class="text-start">
                    <a href="#" class="text-dark link-underline link-underline-opacity-0">
                        <div class="btn btn-dark px-3" data-bs-toggle="modal" :data-bs-target="'#newAdmin' + p.id">اضافه کردن ادمین جدید</div>
                    </a>
                </div>
            ...
            <div class="mt-2">
                <div v-for="u in p.admins" :key="u.id" class="row flex-row-reverse align-items-center my-3">
                    <div class="col d-flex flex-row-reverse">
                        <img class="item-img" style="width: 45px; height: 45px; border-radius: 100%;" :src="u.image" alt="">
                        <div class="align-self-center me-2">
                            {{ u.username }}
